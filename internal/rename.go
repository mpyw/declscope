...
// which objects are namedInReport from files the pass did not collect, which names a
...
type renameState struct {
	...
	// outside marks every object namedInReport from a file in pass.Files that the
...
func (c *collection) safeToRename(pass *analysis.Pass, t *target, newName string) bool {
	...
	// declaration namedInReport like an import in any file of the package, not only
...
// usedOutside returns every object namedInReport from a file the pass did not collect.
