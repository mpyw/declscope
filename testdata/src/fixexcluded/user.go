...
func load() int { return 1 } // want `func load does not carry the prefix of namespace "user"; rename it to userLoad`
...
func spare() int { return 2 } // want `func spare does not carry the prefix of namespace "user"; rename it to userSpare`

// Named nowhere outside this file, so nothing the excluded file writes is
// disturbed and the rename is offered.
func free() int { return 3 } // want `func free does not carry the prefix of namespace "user"; rename it to userFree`
