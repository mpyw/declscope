...
type UserT struct { //declscope:ignore escape
	x int
}
...
type UserW struct { w int //declscope:ignore escape
...
//
//declscope:ignore escape // want `misplaced declscope:ignore: no declaration here for it to bind to`
