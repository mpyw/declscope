...
var ErrClosed = 2 // want `var ErrClosed does not carry the prefix of namespace "client"; rename it to ClientErrClosed`

func helper() int { return 3 } // want `func helper does not carry the prefix of namespace "client"; rename it to clientHelper`
