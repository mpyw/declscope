...
type count struct{ n int } // want `type count does not carry namespace "user" anywhere in its name; rename it to userCount, or to another name that carries "user"`
