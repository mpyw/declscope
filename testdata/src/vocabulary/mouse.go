...
func pinwheel() int { return 2 } // want `func pinwheel does not carry namespace "mouse" anywhere in its name; rename it to mousePinwheel`

// A name outside the vocabulary is asked as usual.
func scrollSpeed() int { return 3 } // want `func scrollSpeed does not carry namespace "mouse" anywhere in its name; rename it to mouseScrollSpeed`
