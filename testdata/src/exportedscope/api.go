...
//
//declscope:private
type entry struct { // want `type entry is declared private by //declscope:private, but is used from namespace "use"` `type entry does not carry the prefix of namespace "api"; rename it to apiEntry`
