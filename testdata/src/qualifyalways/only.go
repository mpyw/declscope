...
func helper() int { return 1 } // want `func helper does not carry namespace "only" anywhere in its name; rename it to onlyHelper, or to another name that carries "only"`
