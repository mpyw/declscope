...
func baz() int { return 1 } // want `func baz does not carry namespace "fooBar" anywhere in its name; rename it to fooBarBaz, or to another name that carries "fooBar"`
