...
func extra() int { return 2 } // want `func extra does not carry namespace "util" anywhere in its name; rename it to utilExtra, or to another name that carries "util"`
